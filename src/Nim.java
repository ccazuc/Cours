...
public class Nim {
		...
		if ( difficulty == 0 ) {
			...
			if ( order > 0 && order <= 0.5 ) {
				...
				while ( billes > 0) {
					...
					else if ( billes == 63 || billes == 31 || billes == 15 || billes == 7 || billes == 3 || billes == 1 ) {
						if(billes == 1) {
							picko = 1;
						}
						else {
					...
					else if ( billes > 31 && billes < 63 ) {
						picko = billes - 31;
					}
					else if ( billes > 15 && billes < 31 ) {
						picko = billes - 15;
					}
					else if ( billes > 7 && billes < 15 ) {
						picko = billes - 7;
					}
					else if ( billes > 3 && billes < 7 ) {
						picko = billes - 3;
					}
					else if ( billes > 1 && billes < 3 ) {
						picko = billes - 1;
					}
					billes-= picko;
					System.out.println("L'ordinateur a pris "+picko+" billes et il reste "+billes+" billes.");
	...
	private static int getPickJ(Scanner input, int billes) {
		...
		do {
			pickj = input.nextInt();
		} while (pickj <= 0 || (billes > 1 && pickj > billes/2) || (billes == 1 && pickj > 1));
		return pickj;
	}
}	
